...
//Helper: Address Block ใช้แสดงที่อยู่ของพนักงาน โดยจัดรูปแบบที่อยู่ให้อ่านง่าย และแสดง "–" เมื่อไม่มีข้อมูลที่อยู่
...
//Loading Spinner ใช้้แสดงสถานะกำลังโหลดข้อมูล โดยมีข้อความที่สามารถปรับได้ผ่าน props message
...
//Empty State ใช้แสดงสถานะเมื่อไม่มีข้อมูล โดยมีข้อความที่สามารถปรับได้ผ่าน props message
export const EmptyState = ({ message = "ไม่มีข้อมูล" }) => (
    <div className="flex flex-col items-center justify-center py-16 text-slate-400">
...
//Error State ใช้แสดงสถานะเมื่อเกิดข้อผิดพลาดในการโหลดข้อมูล โดยมีข้อความที่สามารถปรับได้ผ่าน props message และมีปุ่มให้ลองโหลดข้อมูลใหม่อีกครั้งผ่าน props onRetry
